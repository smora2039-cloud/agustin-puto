...
public class proyecto_progra {
  ...
  static String[][] registroProduccion = new String[100][10];
  // --Ints
  static int vaca = 250;
  static int alimento = 100;
  static int produccion = 400;
...
public static int siguienteProduccion() {
    int indice = -1;
    for (int i = 0; i < 100; i++) {
      if (registroProduccion[i][0].equals("")) {
        indice = i;
        break;
      }
    }
  ...
  public static void registrarProduccion() {
    ...
    System.out.println("----------------------------------------");
    System.out.println("Digite la posicion para almacenar");
    System.out.println("la produccion (1-100): ");
    System.out.println("");
    System.out.print("Opcion: ");
    opcion = leer.nextInt();
    int fila = siguienteProduccion();
    leer.nextLine(); // Evitar error de lectura
    ...
    if (registroProduccion[fila][1].equals("")) {
      int id = (fila + 1) + produccion;
 
      System.out.println("");
      System.out.println("Digite el numero de semana del anio: ");
      String semanaProduccion = leer.nextLine();
      ...
      System.out.println("");
      System.out.println("Digite la cantidad producida el Lunes (Litros): ");
      Double lunes = leer.nextDouble();
 
      System.out.println("");
      System.out.println("Digite la cantidad producida el Martes (Litros): ");
      Double martes = leer.nextDouble();
 
      System.out.println("");
      System.out.println("Digite la cantidad producida el Miercoles (Litros): ");
      Double miercoles = leer.nextDouble();
 
      System.out.println("");
      System.out.println("Digite la cantidad producida el Jueves (Litros): ");
      Double jueves = leer.nextDouble();
 
      System.out.println("");
      System.out.println("Digite la cantidad producida el Viernes (Litros): ");
      Double viernes = leer.nextDouble();
 
      System.out.println("");
      System.out.println("Digite la cantidad producida el Sabado (Litros): ");
      Double sabado = leer.nextDouble();
 
      System.out.println("");
      System.out.println("Digite la cantidad producida el Domingo (Litros): ");
      Double domingo = leer.nextDouble();
      leer.nextLine();
 
      registroProduccion[fila][0] = String.valueOf(id);
      registroProduccion[fila][1] = semanaProduccion;
      registroProduccion[fila][2] = codigoVaca;
      registroProduccion[fila][3] = String.valueOf(lunes);
      registroProduccion[fila][4] = String.valueOf(martes);
      registroProduccion[fila][5] = String.valueOf(miercoles);
      registroProduccion[fila][6] = String.valueOf(jueves);
      registroProduccion[fila][7] = String.valueOf(viernes);
      registroProduccion[fila][8] = String.valueOf(sabado);
      registroProduccion[fila][9] = String.valueOf(domingo);
    } else {
      System.out.println("La posicion esta ocupada");
    }
}
 
// --Metodo para modificar produccion de leche
public static void modificarProduccion() {
    System.out.println("----------------------------------------");
    System.out.println("|      MODIFICACION DE PRODUCCION      |");
    System.out.println("----------------------------------------");
    System.out.println("Digite el numero de registro");
    System.out.println("a modificar: ");
    System.out.println("");
    String buscaProduccion = leer.nextLine();
 
    boolean encontrada = false;
    for (int i = 0; i < 100; i++) {
      if (buscaProduccion.equals(registroProduccion[i][0])) {
        encontrada = true;
        ...
        registroProduccion[i][1] = semanaProduccion;
        registroProduccion[i][2] = codigoVaca;
        registroProduccion[i][3] = String.valueOf(lunes);
        registroProduccion[i][4] = String.valueOf(martes);
        registroProduccion[i][5] = String.valueOf(miercoles);
        registroProduccion[i][6] = String.valueOf(jueves);
        registroProduccion[i][7] = String.valueOf(viernes);
        registroProduccion[i][8] = String.valueOf(sabado);
        registroProduccion[i][9] = String.valueOf(domingo);
...
// --Metodo para eliminar produccion de leche
public static void eliminarProduccion() {
    System.out.println("---------------------------------------");
    System.out.println("|      ELIMINACIÓN DE PRODUCCION      |");
    System.out.println("---------------------------------------");
    System.out.println("");
    System.out.println("Digite el numero de registro");
    System.out.println("a eliminar: ");
    ...
    for (int i = 0; i < 100; i++) {
      if (buscaProduccion.equals(registroProduccion[i][0])) {
        for (int j = 0; j < 10; j++) {
          registroProduccion[i][j] = "";
        }
      }
    }
}
 
// --Metodo para consultar produccion de leche
public static void consultarProduccion() {
    System.out.println("---------------------------------------");
    System.out.println("|       LISTADO DE PRODUCCION         |");
    System.out.println("---------------------------------------");
    System.out.println("");
    for (int i = 0; i < 100; i++) {
      if (!registroProduccion[i][0].equals("")) {
        System.out.println("Numero: " + registroProduccion[i][0]);
        System.out.println("Semana: " + registroProduccion[i][1]);
        System.out.println("Codigo de la vaca: " + registroProduccion[i][2]);
        System.out.println("Lunes (Litros): " + registroProduccion[i][3]);
        System.out.println("Martes (Litros): " + registroProduccion[i][4]);
        System.out.println("Miercoles (Litros): " + registroProduccion[i][5]);
        System.out.println("Jueves (Litros): " + registroProduccion[i][6]);
        System.out.println("Viernes (Litros): " + registroProduccion[i][7]);
        System.out.println("Sabado (Litros): " + registroProduccion[i][8]);
        System.out.println("Domingo (Litros): " + registroProduccion[i][9]);
      }
    }
}
 
// --Metodo para Gestionar la Produccion Lechera
public static void registroProduccionLechera() {
    int opcion = 0;
    do {
      System.out.println("----------------------------------------");
      System.out.println("|     GESTION DE PRODUCCION LECHERA    |");
      System.out.println("----------------------------------------");
      System.out.println("Ingrese una opción (1-5) luego presione ");
      System.out.println("la tecla enter.");
      System.out.println("");
      System.out.println("1. Registrar Produccion");
      System.out.println("2. Modificar Produccion");
      System.out.println("3. Eliminar Produccion");
      System.out.println("4. Consultar Produccion");
      System.out.println("5. Regresar");
      System.out.println("----------------------------------------");
      System.out.println("");
      System.out.print("Opcion: ");
...
// --Metodo para el Reporte de Alimentacion
public static void reporteAlimentacion() {
    System.out.println("---------------------------------------");
    System.out.println("|        REPORTE DE ALIMENTACION      |");
    System.out.println("---------------------------------------");
    System.out.println("");
    System.out.println("Semana\tVaca\tAlimento\tCantidad (Kg)");
    for (int i = 0; i < 100; i++) {
      if (!registroAlimentacion[i][0].equals("")) {
        String codigoVaca = registroAlimentacion[i][1];
        String codigoAlimento = registroAlimentacion[i][2];
        String nombreVaca = "";
        String nombreDelAlimento = "";
 
        for (int j = 0; j < 100; j++) {
          if (codigoVaca.equals(nombreVacas[j][1])) {
            nombreVaca = nombreVacas[j][2];
            break;
          }
        }
        ...
        for (int k = 0; k < 100; k++) {
          if (codigoAlimento.equals(nombreAlimento[k][1])) {
            nombreDelAlimento = nombreAlimento[k][2];
            break;
          }
        }
 
        if (!nombreVaca.equals("") && !nombreDelAlimento.equals("")) {
          System.out.println(registroAlimentacion[i][4] + "\t" + nombreVaca + "\t"
              + nombreDelAlimento + "\t" + registroAlimentacion[i][3]);
        }
      }
    }
}
 
// --Metodo para el Reporte de Produccion
public static void reporteProduccion() {
    System.out.println("---------------------------------------");
    System.out.println("|        REPORTE DE PRODUCCION        |");
    System.out.println("---------------------------------------");
    System.out.println("");
    System.out.println("Semana\tVaca\tCantidad (Litros)");
    for (int i = 0; i < 100; i++) {
      if (!registroProduccion[i][0].equals("")) {
        String codigoVaca = registroProduccion[i][2];
        String nombreVaca = "";
        ...
        double total = Double.parseDouble(registroProduccion[i][3])
            + Double.parseDouble(registroProduccion[i][4])
            + Double.parseDouble(registroProduccion[i][5])
            + Double.parseDouble(registroProduccion[i][6])
            + Double.parseDouble(registroProduccion[i][7])
            + Double.parseDouble(registroProduccion[i][8])
            + Double.parseDouble(registroProduccion[i][9]);
 
        if (!nombreVaca.equals("")) {
          System.out.println(registroProduccion[i][1] + "\t" + nombreVaca + "\t" + total);
        }
      }
    }
}
...
public static void reportes() {
    ...
    do {
      ...
      System.out.println("----------------------------------------");
      System.out.println("Ingrese una opción (1-3) luego presione ");
      System.out.println("la tecla enter.");
      System.out.println("");
      System.out.println("1. Reporte de Alimentacion");
      System.out.println("2. Reporte de Produccion");
    ...
    do {
      ...
      switch (opcion) {
        ...
        case 3: registroAlimentario();
            break;
        case 4: registroProduccionLechera();
            break;
        case 5: reportes();
            break;
